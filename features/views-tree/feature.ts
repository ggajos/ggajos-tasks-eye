...
export default defineFeature({
  title: "Tree view",
  summary:
    "The Tree view opens in a side panel and shows where the active note sits in the `up` hierarchy: the spine from the root down to the current note, then the full subtree of notes beneath it, all as clickable Obsidian links.",
  acceptanceCriteria: [
    ...
    "The current note is highlighted between its ancestors and descendants.",
    "Notes render as native Obsidian links; clicking one opens it and re-anchors the panel.",
